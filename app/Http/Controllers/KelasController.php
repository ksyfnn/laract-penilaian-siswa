...
class KelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kelas/index')->with('success', 'data has been uploaded!!!');
    }
    ...
    public function update(Request $request, Kelas $kelas)
    {
        ...
        return redirect('/kelas/index')->with('success', 'data has been updated!!!');
    }
    ...
    public function destroy(Kelas $kelas)
    {
        ...
        $kelas->delete();
        return back()->with('success', 'data kelas has been deleted!!!');
    }
}
